...
class HotelListData {
  ...
  static List<HotelListData> hotelList = [
    HotelListData(
      ...
      titleTxt: 'Madpackers Rishikesh OG',
    ...
    HotelListData(
      ...
      titleTxt: 'Madpackers Pushkar',
      subTxt: 'Pushkar, Rajasthan',
      dist: 0.9,
      reviews: 74,
      rating: 4.5,
      perNight: 330,
    ...
    HotelListData(
      ...
      titleTxt: 'Madpackers Amritsar',
      subTxt: 'Amritsar, Punjab',
      dist: 2.0,
      reviews: 62,
      rating: 4.0,
      perNight: 364,
    ...
    HotelListData(
      ...
      titleTxt: 'Madpacker Manali',
      subTxt: 'Manali, Himachal Pradesh',
      dist: 1.9,
      reviews: 90,
      rating: 4.4,
      perNight: 304,
